...
Redmine::AccessControl.map do |map|
  ...
  map.project_module :departments do |map|
    map.permission :manage_departments, {:departments => [:new, :create, :edit, :update, :destroy, :show]}, :require => :member
    map.permission :manage_department_members, {:department_members =>  [:new, :create,  :update, :destroy, :show, :autocomplete]}, :require => :member
  end
...
Redmine::MenuManager.map :project_menu do |menu|
  ...
  menu.push :performances, { :controller => 'performances', :action => 'index' }, :param => :project_id, :caption => :label_performance_plural

namespace :db do
    namespace :backup do
        ...
        desc "Backup the database to a file. Options: DIR=base_dir Rails.env=production DATE=2008-10-11"
        ...
        desc "Remove all the batabase backup files which had been created before a certain date, default is today. Options: DIR=base_dir Rails.env=production DATE=2008-10-11"
        ...
        desc "Rebuild the database with a certain back file. Options: DIR=basedir Rails.env=production"
